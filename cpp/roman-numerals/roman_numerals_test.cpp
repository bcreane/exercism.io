...
BOOST_AUTO_TEST_CASE(nine_hundred_ten_yields_CMX)
{
    BOOST_REQUIRE_EQUAL("CMX", roman::convert(910));
}

BOOST_AUTO_TEST_CASE(nine_hundred_one_yields_CMI)
{
    BOOST_REQUIRE_EQUAL("CMI", roman::convert(901));
}
